...
class QuadForm(Scene):
    def construct(self):
        ...
        text2 = Text("Derivation of the quadratic formula", font_size=25)
        ...
        textgroup2 = VGroup(text4, text5).shift(UP*32/9)
        line1 = Line(LEFT, RIGHT).scale(4).shift(DOWN*.25)
        ...
        dot1 = Dot(LEFT*1.23 + DOWN*32/9)
        text7 = MathTex(r"x_1").next_to(dot1, UR)
        dot2 = Dot(RIGHT*2.23+ DOWN*32/9)
        ...
        # indicate vertex
        text9 = Text("The x of the vertex is in the \ncenter of the roots, and satisfies:", font_size= 25).shift(UP*32/9)
        dot3 = Dot(RIGHT*1/2 + DOWN*32/9)
        text10 = MathTex(r"x_{\text{v}}").next_to(dot3, DOWN).align_to(dot3, LEFT).shift(RIGHT*.2)
        line2 = DashedLine(UP, DOWN).shift(RIGHT*1/2 + DOWN*32/9).scale(3)
        self.play(
            FadeIn(dot3),
            FadeIn(text10),
            FadeIn(line2),
        ...
        # derive x_v
        text11 = MathTex(r"f'(x_{\text{v}}) = 0").shift(UP*32/9 + DOWN)
        text12 = MathTex(r"f'(x) = 2ax + b = 0").shift(UP*32/9 + DOWN*2)
        text13 = MathTex(r"2ax = -b").shift(UP*32/9 + DOWN*3)
        textgroup3 = VGroup(text11, text12, text13)
        textgroup4 = VGroup(text4, text5, text6, text9, textgroup3)
        text14 = MathTex(r"x_{\text{v}} = -\frac{b}{2a}").shift(UP*32/9 + DOWN*3)
        ...
        text15 = Text("f(x) can also be rewritten as:", font_size=25).shift(UP*32/9 + UP)
        text16 = MathTex(r"f(x) = a(x - x_1)(x - x_2)").shift(UP*32/9)
        text17 = MathTex(r"= ax^2 - (x_1 + x_2)ax + ax_1x_2").shift(UP*32/9 + DOWN)
        text18 = Text("By comparing coefficients we see:", font_size=25).shift(UP*32/9 + DOWN*2)
        text19 = MathTex(r"x_1x_2 = \frac{c}{a}").shift(UP*32/9 + DOWN*3)
        ...
        # solve for d
        text22 = MathTex(r"x_1 = x_{\text{v}} - d \wedge x_2 = x_{\text{v}} + d").shift(UP*3/2 + UP*32/9)
        text23 = MathTex(r"x_1x_2 = (x_{\text{v}} - d)(x_{\text{v}} + d) = \frac{c}{a}").shift(UP*32/9)
        text24 = MathTex(r"x_{\text{v}}^2 - d^2 = \frac{c}{a}").shift(DOWN*3/2 + UP*32/9)
        text25 = MathTex(r"d^2 = x_{\text{v}}^2 - \frac{c}{a}").shift(DOWN*3 + UP*32/9)
        text26 = MathTex(r"d^2 = \left(-\frac{b}{2a}\right)^2 - \frac{c}{a}").shift(DOWN*3 + UP*32/9)
        text27 = MathTex(r"d^2 = \frac{b^2}{4a^2} - \frac{4ac}{4a^2}").shift(DOWN*3/2 + UP*32/9)
        text28 = MathTex(r"d^2 = \frac{b^2 - 4ac}{4a^2}").shift(DOWN*3 + UP*32/9)
        text29 = MathTex(r"d = \sqrt{\frac{b^2 - 4ac}{4a^2}}").shift(DOWN*3/2 + UP*32/9)
        text30 = MathTex(r"d = \frac{\sqrt{b^2 - 4ac}}{2a}").shift(DOWN*3 + UP*32/9)
        ...
        # solve for x_{1,2}
        text31 = MathTex(r"x_{1, 2} = x_v \pm d").shift(UP*32/9)
        self.play(
            FadeOut(text28),
            FadeOut(text29),
            run_time= 1
        ...
        self.wait(1)
        text32 = MathTex(r"x_{1, 2} = \frac{-b}{2a} \pm \frac{\sqrt{b^2 - 4ac}}{2a}").shift(DOWN*3/2 + UP*32/9)
        text3.shift(DOWN*7/4 + UP*32/9)
        ...
        self.play(
            FadeOut(group1),
            text3.animate().move_to(ORIGIN).scale(1.5),
            run_time= 2
        )
