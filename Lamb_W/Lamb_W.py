...
class LambW(Scene):
    def construct(self):
        ...
        text10 = MathTex(r"3^{735}\cdot \ln(3) = \ln(3)\cdot(735 - x) \cdot e^{(735 - x)\cdot \ln(3)}").shift(UP*1.25)
        ...
        text12 = MathTex(r"W\left(3^{735}\cdot \ln(3)\right) = W\left(\ln(3)\cdot(735 - x) \cdot e^{(735 - x)\cdot \ln(3)}\right)").shift(DOWN/4)
        ...
        # give approximation
        text16 = Tex("We can calculate the Lambert W of a constant:").shift(UP*3/2)
        ...
        # outro
        text20 = Tex("Thanks for watching!").shift(RIGHT*32/9 + DOWN*2)
